# booking_main.py
# BIBLIOMAP – Hash Table + Object-Oriented Programming (Final Improved Version)
...
class Seat:
    ...
    def __init__(self, seat_id):
        ...
        self.occupied = False
        self.study_time = None  # Store time window for study sessions

    def not_empty(self, study_time):
        # Marks the seat as occupied and stores time window.
        self.occupied = True
...
class Library:
    ...
    def display_map(self):
        # Displays a simple seating map with column numbers.
    ...
    def book_seat(self, seat_id, study_time):
        # Books a seat if available and saves study time.
    ...
    def manage_library(self, library):
        ...
        while True:
            ...
            if action == "1":
                ...
                study_time = input("Enter how many hours you plan to study: ")
                print(library.book_seat(seat_id, study_time))

                # Add immediate exit or continue options
                next_action = input(
                    "\nWould you like to (1) Cancel a seat, (2) Finish studying, (3) Exit Bibliomap, or (4) Continue? "
                )
                if next_action == "1":
                    ...
                    print("👋 Thank you for using Bibliomap! Goodbye!")
                    exit()
